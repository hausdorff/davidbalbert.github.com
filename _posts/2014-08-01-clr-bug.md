...
(**Update:** what I forgot to mention is that we're running against the .NET native developer toolchain, which uses a slightly different version of *System.Linq.Expressions.dll*. But, the code in question)

...
I work at Microsoft. Competing with Google is hard work. I'm going to point out of some of the lessons I've learned along the way, to help all you spry young entrepreneurs who might want to enter the market.


### Lesson 1: The problem is not only hiring smart people, but hiring *enough* smart people.

The Bing search relevance staff is probably ~20% the size of Google's. And Google's engineers are amazing. It might be possible to make up for a small difference in size, but competing with a brilliant workforce that is *5 times as large* is very hard.

What's worse is that the problem is not even buying such a team. MS is rich enough that it could do that if it wanted to. The problem is *finding enough people* to build such a team. There are a limited number of search relevance engineers available, and many of them work for Google.
...
Bing holds somewhere around ~20% of market share. The field is still dominated by Google, but this is no small chunk.

In contrast, consider that we've invested *at least* tens of millions into *just* search relevance &mdash; I'm not even counting infrastructure here. Since there aren't enough relevance engineers to go around, we've been forced to make creative investments in getting the relevance ratings we have.

In this sense, we've gotten pretty good mileage out of our team, but the fact remains: the difference in search quality &mdash; perceived or real &mdash; is noticeable to a large subset of the people who use search regularly. More specifically, as an entrepreneur you have to answer this question: **how would you make these investments differently, and how much money would you need to do it correctly?**

Ultimately this will be a very hard gap to bridge directly, and entrepreneurs should plan accordingly.
...
What's more is that these solutions tend to be developed end-to-end, so that they all fit together, and are designed to work together. This is not usually true of OSS, where you tend to cobble together lots of ill-fitting tools until your system starts limping along.

But this should give you a sense of the scale at which these companies operate. Entrepreneurs should not expect to compete with the raw processing power of a company like Google. You will have to either be very smart about holes in their stack, or you will have to find another way.
...
Most computers are basically used as Internet access devices. At this point, MS has accepted the transition to being a "devices and services" company.

This means that the job of MS is now to supply the Internet as a service to consumers, and in order to do this well, MS cannot only be the OS and the browser that are used to access the Internet. It must also be the landing page. This is the real function of bing, and if MS gives up on it, it might as well give up on all consumer investments.

For this reason, it is more important that Bing (for the moment) that Bing exists than it is that it is equal to or better than Google in every way.
